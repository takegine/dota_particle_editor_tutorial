...
<li><a href="#oscillate-vector-simple">振动矢量简单</a></li>
...
<li><a href="#color-random">颜色随机</a></li>
...
<li><a href="#alpha-window-threshold-random">Alpha 窗口阈值随机</a></li>
...
<li><a href="#set-control-point-to-impact-point">设置控制点到撞击点</a></li>
